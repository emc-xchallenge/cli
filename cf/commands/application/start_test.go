...
var _ = Describe("Start", func() {
	var (
		...
		appRepo    *testapplications.FakeApplicationRepository
		// appInstancesRepo *testAppInstances.FakeAppInstancesRepository
		logRepo *testapi.FakeOldLogsRepository
		deps    command_registry.Dependency

		loginRequirement         requirements.Requirement
		targetedSpaceRequirement *fakerequirements.FakeTargetedSpaceRequirement
		applicationRequirement   requirements.Requirement
	...
	BeforeEach(func() {
		...
		repoLocator := deps.RepoLocator.SetApplicationRepository(appRepo)
		...
		factory.NewTargetedSpaceRequirement(targetedSpaceRequirement)

		loginRequirement = &passingRequirement{}
		factory.NewLoginRequirementReturns(loginRequirement)

		applicationRequirement = &fakerequirements.FakeApplicationRequirement{}
		applicationRequirement.ExecuteReturns(true)
		factory.NewOrganizationRequirementReturns(applicationRequirement)
	...
	Describe("Requirements", func() {
		...
		Context("when provided exactly one arg", func() {
			...
			It("returns an ApplicationRequirement", func() {
				...
				Expect(factory.NewApplicationRequirementArgsForCall(0)).To(Equal("the-org-name"))
...
//	startAppWithInstancesAndErrors := func(displayApp ApplicationDisplayer, app models.Application, requirementsFactory *testreq.FakeReqFactory) (*testterm.FakeUI, *testApplication.FakeApplicationRepository, *testAppInstances.FakeAppInstancesRepository) {
//		appRepo = &testApplication.FakeApplicationRepository{}
